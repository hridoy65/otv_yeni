# -*- coding: utf-8 -*-
# vStream https://github.com/Kodi-OTV_MEDIA/venom-xbmc-addons
...
class dialog:
    ...
    def VSerror(self, e):
        return self.DIALOG.notification('OTV_MEDIA', 'Erreur: ' + str(e), xbmcgui.NOTIFICATION_ERROR, 2000), VSlog('Erreur: ' + str(e))
...
class listitem(xbmcgui.ListItem):
    ...
    def addMenu(self, sFile, sFunction, sTitle, oOutputParameterHandler=False):
        sPluginPath = 'plugin://plugin.video.OTV_MEDIA/'  # cPluginHandler().getPluginPath()
...
class siteManager:
    ...
    def __init__(self):
        ...
        self.defaultPath = VSPath('special://home/addons/plugin.video.OTV_MEDIA/resources/sites.json')
        self.defaultData = None

        # Propriétés selon le profil        
        name = VSProfil()
        if name == 'Master user':   # Le cas par defaut
            path = VSPath('special://home/userdata/addon_data/plugin.video.OTV_MEDIA/sites.json')
        else:
            path = VSPath('special://home/userdata/profiles/' + name + '/addon_data/plugin.video.OTV_MEDIA/sites.json')
