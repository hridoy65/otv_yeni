...
#from resources.sites import youtubecom_tr        
...
class AbstractContext(object):
    ...
    def create_uri(self, path=u'/', params=None):
        ...
        #param.addParameter('siteUrl', 'http://')
        #youtubecom_tr.kYouTUBE(path)
        if not params:
            params = {}
       ...
       # youtubecom_tr.kYouTUBE(uri)
        ...
        return uri #,youtubecom_tr.vidbox(uri)
    ...
    def get_params(self):
        #youtubecom_tr.vidbox(self._params)
        return self._params
