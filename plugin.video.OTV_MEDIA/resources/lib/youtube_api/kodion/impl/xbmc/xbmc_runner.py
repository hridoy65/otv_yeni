...
class XbmcRunner(AbstractProviderRunner):
    ...
    def _add_directory(self, context, directory_item, item_count=0):
        ...
        xbmcplugin.addDirectoryItem(handle=self.handle,url=directory_item.get_uri(),listitem=item,isFolder=is_folder,totalItems=item_count)
    ...
    def _add_video(self, context, video_item, item_count=0):
        ...
        xbmcplugin.addDirectoryItem(handle=self.handle,url=video_item.get_uri(),listitem=item,totalItems=item_count)
