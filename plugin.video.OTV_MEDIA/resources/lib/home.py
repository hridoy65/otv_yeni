...
class cHome:
    ...
    def load(self):
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://orhantv')
        oGui.addDir('xiptvozel', 'kurdtv', 'KÜrd Media', 'karwan-tv-1.png', oOutputParameterHandler)
...
#        oGui.addDir('xiptvozel', 'STB_EMUM_info', 'STB Emulator', 'stbemu.png', oOutputParameterHandler)
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://orhantv')
        oGui.addDir('adult_eu', 'turkupdate', 'SPEED-HIZLI-MODULE-UPDATE-GUNCELLE' , 'update.png', oOutputParameterHandler)

        
#        oOutputParameterHandler = cOutputParameterHandler()
#        oOutputParameterHandler.addParameter('siteUrl', 'http://orhantv')
#        oGui.addDir('mmovies365', 'homeMovies365', self.ADDON.VSlang(30022) , 'movsinema.jpg', oOutputParameterHandler)
