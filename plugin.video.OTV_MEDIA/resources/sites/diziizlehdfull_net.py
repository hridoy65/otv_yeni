...
def diziizlehdfulltr():
    ...
    oOutputParameterHandler.addParameter('siteUrl', 'TRModules@https://www.dizibox.tv/@start@dizibox')
...
def ssshowMovies(sSearch = ''):
    ...
    if not (aResult[0] == False):
        ...
        for aEntry in aResult[1]:
            ...
            sTitle = malfabekodla(sTitle)
            Url ='TRModules@'+sUrl+'@category@'+ sTitle
            logger.info("rUrl: %s" %Url)
            oOutputParameterHandler = cOutputParameterHandler()
